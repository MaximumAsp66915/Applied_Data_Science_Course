...
SESSION_KEY_FILE = f"{PROJECT_ROOT}/db/internal_db/internal_db_key.key"
STRUCTURE_ROOT = f"{PROJECT_ROOT}/db/db_files/internal_db_structure.json"
...
class Internal_DB_Connection(PostgreSQL):
    _lock = asyncio.Lock()
    ...
    async def reset(self) -> bool:
        async with Internal_DB_Connection._lock:
            try:
